...
let budgetController = (function () {
    ...
    return {
        ...
        calculateBudget: function () {
            ...
            // Calculate ther percentage of income
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            if (type === 'inc') {
                ...
                html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div><div class="item__percentage">21%</div><div class="item__delete"><buttonclass="item__delete--btn"><iclass="ion-ios-close-outline"</i></button></div></div></div>'
            }

            // Replace the placeholder text xith some actual data
        ...
        displayBudget: function (obj) {
            let type;
            obj.object > 0 ? type = 'inc' : type='exp'
